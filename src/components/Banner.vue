    ...
    <div>
        <section class="banner-background relative border-b border-primary-50 pb-10 bg-opacity-10"   >
            <div class="hero-section style-two">
                <div class="mx-auto max-w-[85rem] px-6 !overflow-hidden">
                    <div class="flex flex-wrap items-center">
                        <div class="w-full lg:w-8/12 md:w-8/12">
                            <div class="hero-content text-start mt-[50px] lg:mt-[150px]">
                                ...
                                <div class="relative w-full max-w-sm mt-3" data-aos="flip-left" data-aos-duration="2000">
                                    ...
                                    <button type="submit" class="absolute right-0 top-0 btn btn-two rounded-full text-white font-semibold m-1 px-5 py-1.5 lg:py-3">Let's Go →
                                    </button>
                                </div>
                        ...
                        <div class="w-full lg:w-4/12 md:w-4/12">
                            <div>
                                 <img src="../assets/mobile2.png" alt="" data-aos="fade-up" data-aos-duration="2000">
                            </div>
                        </div>
                ...
                <div class="hero-shape-img shape1 absolute right-0 top-[10%] overflow-hidden">
                    <img src="../assets/herologo.png" alt=""
                    style="animation: snowRot 10s 0.4s infinite;">
                </div>
                <div class="hero-shape-img shape2 bounce-animate3 absolute z-[-1] left-[3%] top-[2%] ">
                    <img src="../assets/hero2.png" alt=""
                    style="animation: float-bob3 4s 0.4s infinite;">
                </div>
                <div class="hero-shape-img shape4 absolute right-0 lg:right-[7%] top-[6%] left-[inherit] hidden lg:block md:block z-[-1]">
